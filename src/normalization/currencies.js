...
const CURRENCIES = [
  ...
  { code: 'CAD', name: '加拿大元', aliases: ['cad'] },
  { code: 'CHF', name: '瑞士法郎', aliases: ['chf'] },
  { code: 'SGD', name: '新加坡元', aliases: ['sgd'] },
  { code: 'THB', name: '泰国铢', aliases: ['泰铢', 'thb'] },
  { code: 'KRW', name: '韩元', aliases: ['韩国元', 'krw'] },
  { code: 'MOP', name: '澳门元', aliases: ['澳门币', 'mop'] },
  ...
  { code: 'RUB', name: '卢布', aliases: ['俄罗斯卢布', 'rub'] },
  { code: 'MYR', name: '林吉特', aliases: ['马来西亚林吉特', 'myr'] },
